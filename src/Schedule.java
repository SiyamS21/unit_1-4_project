public class Schedule {
    ...
    public Schedule(int grade) {
        if (grade == 9) {
            ...
            dayOnePeriodTwo= "Physical Education";
            dayTwoPeriodTwo= "Freshman Advisory";
            dayThreePeriodTwo= "Physical Education";
            dayFourPeriodTwo= "Living Environment Lab";
            dayFivePeriodTwo= "Physical Education";
            daySixPeriodTwo= "Freshman Advisory";
            daySevenPeriodTwo= "Physical Education";
            dayEightPeriodTwo= "Living Environment Lab";
            dayNinePeriodTwo= "Physical Education";
            dayTenPeriodTwo= "Gap Lunch";
            dayOnePeriodThree= "English 9";
            dayTwoPeriodThree= "DDP (Design, Draft, Production)";
            dayThreePeriodThree= "English 9";
            dayFourPeriodThree= "DDP (Design, Draft, Production)";
            dayFivePeriodThree= "English 9";
            daySixPeriodThree= "DDP (Design, Draft, Production)";
            daySevenPeriodThree= "English 9";
            dayEightPeriodThree= "DDP (Design, Draft, Production)";
            dayNinePeriodThree= "English 9";
            dayTenPeriodThree= "DDP (Design, Draft, Production)";
            dayOnePeriodFour= "English 9";
            dayTwoPeriodFour= "DDP (Design, Draft, Production)";
            dayThreePeriodFour= "English 9";
            dayFourPeriodFour= "DDP (Design, Draft, Production)";
            dayFivePeriodFour= "English 9";
            daySixPeriodFour= "DDP (Design, Draft, Production)";
            daySevenPeriodFour= "English 9";
            dayEightPeriodFour= "DDP (Design, Draft, Production)";
            dayNinePeriodFour= "English 9";
            dayTenPeriodFour= "DDP (Design, Draft, Production)";
            dayOnePeriodFive= "Pre-AP World History";
            dayTwoPeriodFive= "Pre-AP World History";
            dayThreePeriodFive= "Pre-AP World History";
            dayFourPeriodFive= "Pre-AP World History";
            dayFivePeriodFive= "Pre-AP World History";
            daySixPeriodFive= "Pre-AP World History";
            daySevenPeriodFive= "Pre-AP World History";
            dayEightPeriodFive= "Pre-AP World History";
            dayNinePeriodFive= "Pre-AP World History";
            dayTenPeriodFive= "Pre-AP World History";
            dayOnePeriodSix= "Spanish I";
            dayTwoPeriodSix= "Spanish I";
            dayThreePeriodSix= "Spanish I";
            dayFourPeriodSix= "Spanish I";
            dayFivePeriodSix= "Spanish I";
            daySixPeriodSix= "Spanish I";
            daySevenPeriodSix= "Spanish I";
            dayEightPeriodSix= "Spanish I";
            dayNinePeriodSix= "Spanish I";
            dayTenPeriodSix= "Spanish I";
            dayOnePeriodSeven= "Algebra / Geometry";
            dayTwoPeriodSeven= "Algebra / Geometry";
            dayThreePeriodSeven= "Algebra / Geometry";
            dayFourPeriodSeven= "Algebra / Geometry";
            dayFivePeriodSeven= "Algebra / Geometry";
            daySixPeriodSeven= "Algebra / Geometry";
            daySevenPeriodSeven= "Algebra / Geometry";
            dayEightPeriodSeven= "Algebra / Geometry";
            dayNinePeriodSeven= "Algebra / Geometry";
            dayTenPeriodSeven= "Algebra / Geometry";
            dayOnePeriodEight= "Algebra / Geometry";
            dayTwoPeriodEight= "Algebra / Geometry";
            dayThreePeriodEight= "Algebra / Geometry";
            dayFourPeriodEight= "Algebra / Geometry";
            dayFivePeriodEight= "Algebra / Geometry";
            daySixPeriodEight= "Algebra / Geometry";
            daySevenPeriodEight= "Algebra / Geometry";
            dayEightPeriodEight= "Algebra / Geometry";
            dayNinePeriodEight= "Algebra / Geometry";
            dayTenPeriodEight= "Algebra / Geometry";
            dayOnePeriodNine= "Lunch";
            dayTwoPeriodNine= "Lunch";
            dayThreePeriodNine= "Lunch";
            dayFourPeriodNine= "Lunch";
            dayFivePeriodNine= "Lunch";
            daySixPeriodNine= "Lunch";
            daySevenPeriodNine= "Lunch";
